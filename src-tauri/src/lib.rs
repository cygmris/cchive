...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::codex::remove_codex_account,
            commands::codex::list_codex_providers,
            commands::codex::get_codex_provider,
            commands::codex::save_codex_provider,
            commands::codex::delete_codex_provider,
            commands::codex::apply_codex_provider,
            commands::codex::clear_codex_provider,
