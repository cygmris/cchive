...
### Visibility
- `[~]` **S6 overview-dashboard** (next) — Overview: hero (account/provider variants), 4 stat tiles (deep‑links), output‑tokens 30‑day chart, tokens‑by‑model bars, recent‑activity feed (real activity log). Covers 17–23.
